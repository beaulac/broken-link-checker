...
function parseOptions(options)
{
	if (options==null || options.__parsed!==true)
	{
		...
		// Backwards compatibility for retry405Head option
		if(options.retry405Head) {
			options.headRetryCodes = options.headRetryCodes || [];

			if(options.headRetryCodes.indexOf(405) < 0) {
				options.headRetryCodes.push(405);
			}
		}
